...
const RUNTIME_NAMES = [
  ...
  'MAINTAINER_ID',
  'MARKET_CODING_IDENTITY_ENABLED',
...
test('the docs index reaches current deployment and market-operations runbooks', () => {
  ...
  assert.match(operations, /Get-FileHash[\s\S]*C561CA4E013CA4DE455293B4004048B9F05F36B52C3BAA220BFC59CDB1ECBC72/u)
  assert.match(operations, /Get-FileHash[\s\S]*F164FFAD722D339567E9C0D8A733C51C96C1B4E20F71487ED4CDB91864BF7344/u)
  assert.doesNotMatch(operations, /api\/me[\s\S]*listings_total -ne/iu)
