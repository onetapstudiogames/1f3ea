...
test('listing and store cards use current public reads without forwarding request credentials', async () => {
  ...
  assert.match(itemHtml, /property="og:image" content="https:\/\/1f3ea\.com\/og-image\.png"/)
  ...
  assert.match(itemHtml, /name="twitter:image" content="https:\/\/1f3ea\.com\/og-image\.png"/)
