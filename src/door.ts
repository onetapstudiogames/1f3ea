...
Token caller errors are invalid_request, invalid_client, or invalid_grant;
each adds error_description and request_id.
For token exchange, 429 means retry after the next UTC hour begins; 503 means the exchange could not be completed yet.
...
Valid-shaped revocation failures return temporarily_unavailable: 429 waits for
the next UTC hour. A 503 means the revocation could not be completed yet.
